    ...
    return (
        <div className="flex items-center justify-center size-full relative overflow-hidden">
            ...
            <div className="flex flex-col absolute inset-0 pointer-events-none bg-neutral-400/40 px-6 sm:px-15 py-4 sm:py-10 gap-4 items-center justify-center">
                {/* title */}
                <div className="relative size-fit min-h-fit max-w-fit rounded-3xl pl-4 pr-3">
                ...
                <div className="relative w-full max-h-full">
                    <Image src={"/journal-images/brown-tape.png"} alt="tape for image frame" width={146} height={49} 
                                           className="absolute -top-4 -left-8 z-10"/>
                    <Image src={"/journal-images/brown-tape.png"} alt="tape for image frame" width={146} height={49} 
                                className="absolute -bottom-4 -right-8 z-10"/>
                    <Image src={"/journal-images/brown-tape-alt.png"} alt="tape for image frame" width={146} height={49} 
                                           className="absolute -top-4 -right-8 z-10"/>
                    <Image src={"/journal-images/brown-tape-alt.png"} alt="tape for image frame" width={146} height={49} 
                                className="absolute -bottom-4 -left-8 z-10"/>

                    <div className="relative flex flex-col sm:flex-row w-full h-fit max-h-full justify-around items-center
                                    rounded-xl p-8 pointer-events-auto gap-4 overflow-y-auto hidden-scrollbar wrap-break-word
